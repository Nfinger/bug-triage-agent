...
`icp.md` SHALL contain a fenced `json` block declaring target industries, company-size ranges, geographies, target persona title patterns, and excluded domains, which the system SHALL parse and validate.
