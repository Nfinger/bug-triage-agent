/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08701660434815f07149e073062aacc5)
// Runtime types generated with workerd@1.20260811.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	OPENROUTER_API_KEY: string;
	SLACK_SIGNING_SECRET: string;
	SLACK_BUG_CHANNEL_ID: string;
	GITHUB_TOKEN: string;
	GITHUB_REPO: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_API_KEY" | "SLACK_SIGNING_SECRET" | "SLACK_BUG_CHANNEL_ID" | "GITHUB_TOKEN" | "GITHUB_REPO" | "GITHUB_WEBHOOK_SECRET" | "CODING_AGENT_LABEL">> {}
}
